...
schema.cc_enemy_group_recall =  {
	attributes = {
		level2 = "comma_list",
		level3 = "comma_list",
	}
}
schema.cc_enemy_group_commander =  {
	attributes = {
		level1 = "comma_list",
		level2 = "comma_list",
		level3 = "comma_list",
...
schema.cc_enemy_group_leader =  {
	attributes = {
		recruit = "comma_list",
	}
}

schema.cc_enemy_group =  {
	tags = {
		recall = {
			type = "single",
			id = "cc_enemy_group_recall",
		},
		commander = {
			type = "single",
			id = "cc_enemy_group_commander",
		},
		leader = {
			type = "list",
			id = "cc_enemy_group_leader",
		},
	},
	attributes = {
		recruit = "comma_list",
...
-- schema.cc_trainer_chance =  {
-- }

schema.cc_trainer_grade =  {
	tags = {
		chance = {
			type = "list",
			id = "cc_trainer_chance"
		},
	},
}
