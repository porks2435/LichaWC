...
local function generate(length, villages, castle, iterations, size, players, island)
	...
	local res = cc_generator_settings_arguments( length, villages, castle, iterations, size, players, island)
	res.max_lakes=10
	...
	res.road_cost = {
		cc_generator_road_cost_classic(),
		dr_road("Ds", "Re", 15),
		dr_road("Dd", "Re", 15),
		dr_road("Gs^Ft", "Re", 20),
	...
	res.village = {
		cc_generator_village(2, 8, 8, 4, 3, 2, 6, 3, 3, 3, 5, 1)
	}
	res.castle = {
