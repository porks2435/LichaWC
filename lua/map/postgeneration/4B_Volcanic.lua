...
return function()
	...
	cc_map_enemy_themed("dwarf", "Giant Mudcrawler", "ud", "Ur^Vud", 5)
	cc_map_enemy_themed("mandate", "Fire Ant Queen", "ud", "Ur^Vud", 5)
	cc_map_enemy_themed("clockwork_dwarves", "Clockwork Salvager", "ud", "Ur^Vud", 5)
end
