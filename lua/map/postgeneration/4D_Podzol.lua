...
local function world_conquest_tek_map_repaint_4d()
	...
	cc_reduce_wall_clusters("Uu,Uu,Uu,Uu,Uh,Uh,Ai")
	cc_fill_lava_chasms()
	...
	-- fix castles
	cc_map_reduce_castle_expanding_recruit("Ce", "Gll^Fet")
	cc_map_reduce_castle_expanding_recruit("Cud", "Rb")
	set_terrain { "Ch",
		f.terrain("Cud"),
	}
...
local function cc_map_4d_post_bunus_decoration()
...
return function()
	...
	cc_map_4d_post_bunus_decoration()
end
