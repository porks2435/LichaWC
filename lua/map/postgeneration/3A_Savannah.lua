...
function world_conquest_tek_map_decoration_3a()
	...
	cc_map_reduce_castle_expanding_recruit("Ce", "Rd")
	set_terrain { "Gs^Vd",
		f.all(
			f.terrain("Gs^Vht"),
...
function cc_castle_swamp_bridge(bridge, directions ,terrain)
...
function world_conquest_tek_castle_swamp_bridges()
	cc_castle_swamp_bridge("Bh\\", "se,nw", "Hh*^*,Mm,Md,,M*^V*")
	cc_castle_swamp_bridge("Bh/", "sw,ne", "Hh*^*,Mm,Md,,M*^V*")
	cc_castle_swamp_bridge("Bh|", "s,n", "Hh*^*,Mm,Md,M*^V*")

	cc_castle_swamp_bridge("Bw|", "s,n", "!,Ds,S*,*^B*,Xu,Q*,M*^*,W*,Ch*,Kh*")
	cc_castle_swamp_bridge("Bw/", "sw,ne", "!,Ds,S*,*^B*,Xu,Q*,M*^*,W*,Ch*,Kh*")
	cc_castle_swamp_bridge("Bw\\", "se,nw", "!,Ds,S*,*^B*,Xu,Q*,M*^*,W*,Ch*,Kh*")
end
...
return function()
	...
	cc_map_enemy_themed("orc", "Giant Scorpion", "o", "Gs^Vo", 8)
	cc_map_enemy_themed("troll", "Giant Scorpion", "o", "Gs^Vo", 8)
	cc_map_enemy_themed("wolf", "Giant Scorpion", "o", "Gs^Vo", 8)
end
