...
-- the odl code used
-- `cc_iterate_roads_to(cc_roads_to_feudal_castle, 3, "Rr")`
-- instead of `roads_to_feudal_castle(3)`
local function cc_roads_to_feudal_castle(radius)
...
local function world_conquest_tek_map_repaint_6d()
	...
	cc_volcanos()
	cc_volcanos_dirt()
	cc_break_walls("M*^Xm", "Mm,Mm,Hh,Hh,Hh^Fp,Hh^Fp,Hh^Tf,Hh^Tf,Gs^Fp,Rb,Rb,Rb")
	cc_break_walls("X*", "Uh,Uh,Uh,Uh,Uh^Tf,Uu^Tf,Uu,Rd,Rd,Rd")
	set_terrain { "Mm^Xm",
		f.all(
			f.terrain("X*"),
	...
	cc_map_reduce_castle_expanding_recruit("Ce,Cd,Coa", "Rrc")
	set_terrain { "Wwf",
		f.all(
			f.terrain("Rrc"),
...
return function()
	...
	cc_map_enemy_themed("undead", "Soulless", "ha", "Aa^Vha", 1)
	cc_map_enemy_themed("elf", "Wolf", "v", "Gg^Ve", 1)
	cc_map_enemy_themed("dwarf", "Giant Mudcrawler", "ud", "Ur^Vud", 1)
	cc_map_enemy_themed("orc", "Giant Scorpion", "o", "Gs^Vo", 1)
	cc_map_enemy_themed("troll", "Giant Scorpion", "o", "Gs^Vo", 1)
	cc_map_enemy_themed("wolf", "Giant Scorpion", "o", "Gs^Vo", 1)
	cc_map_enemy_themed("human", "Young Ogre", "e", "Gg^Vl", 1)
	cc_map_enemy_themed("drake", "Fire Guardian", "d", "Gg^Vd", 1)
	cc_map_enemy_themed("lizard", "Fire Guardian", "d", "Gg^Vd", 1)
	cc_map_enemy_themed("aberrant", "False Thing", "ha", "Aa^Vha", 1)
	cc_map_enemy_themed("celestials", "Fire Guardian", "v", "Gg^Ve", 1)
	cc_map_enemy_themed("clockwork_dwarves", "Clockwork Salvager", "ud", "Ur^Vud", 1)
	cc_map_enemy_themed("uruk", "Terror Owl", "o", "Gs^Vo", 1)
	cc_map_enemy_themed("harpies", "Elder Falcon", "o", "Gs^Vo", 1)
	cc_map_enemy_themed("quenoth", "Giant Scorpion", "o", "Gs^Vo", 1)
	cc_map_enemy_themed("windsong", "War Harbinger", "e", "Gg^Vl", 1)
	cc_map_enemy_themed("mandate", "Shadow Jumping Spider", "d", "Gg^Vd", 1)
	cc_map_enemy_themed("steelhive", "Clockwork Salvager", "d", "Gg^Vd", 1)
end
