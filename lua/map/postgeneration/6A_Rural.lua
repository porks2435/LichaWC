...
local function world_conquest_tek_map_decoration_6a()
	...
	cc_map_reduce_castle_expanding_recruit("Ce", "Rrc")
	set_terrain { "Ch",
		f.terrain("Ce"),
	}
	...
	cc_storm(terrain_to_change1, rand_choice1 + 2)

	cc_expand_snow()
	cc_storm(terrain_to_change1, rand_choice1)
