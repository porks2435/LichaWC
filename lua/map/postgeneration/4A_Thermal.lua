...
function world_conquest_tek_map_decoration_4a()
	...
	cc_possible_map4_castle("Cv^Fds", 1)
...
function cc_map_4a_post_bunus_decoration()
...
return function()
	...
	cc_map_4a_post_bunus_decoration()
end
