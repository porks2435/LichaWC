...
function world_conquest_tek_map_decoration_3b()
	...
	cc_map_reduce_castle_expanding_recruit("Chs", "Re")
	-- hunging bridges between high terrain
	cc_hunging_bridge("\\", "nw,se")
	cc_hunging_bridge("|", "n,s")
	cc_hunging_bridge("/", "ne,sw")
...
function cc_hunging_bridge(bridge, directions)
...
return function()
	...
	cc_map_enemy_themed("drake", "Fire Guardian", "d", "Gs^Vd", 8)
	cc_map_enemy_themed("lizard", "Fire Guardian", "d", "Gs^Vd", 8)
end
