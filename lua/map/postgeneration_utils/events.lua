...
function cc_fix_impassible_item_spawn()
...
function cc_reduce_wall_clusters(cave_terrain)
...
function cc_castle_expansion_side(side_num)
...
function cc_enemy_castle_expansion()
	...
	for side_num = n_player_sides + 1, n_total_sides do
		cc_castle_expansion_side(side_num)
	end
end
